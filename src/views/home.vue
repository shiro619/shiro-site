<template>
  <div>
    ...
    <img src="@/assets/homebg.png" id="role">
  </div>
</template>
...
export default {
  ...
  mounted () {
    ...
    var layers = [
      {
        ctx: context1,
        count: 1000, // 2000个在其他浏览器上比较卡推荐 chrome
        size: { max: 20, min: 4 },
    ...
    _this.times.push(time1)
    _this.times.push(time2)
    _this.$store.commit('SET_TIME', _this.times)
  }
}
</script>
